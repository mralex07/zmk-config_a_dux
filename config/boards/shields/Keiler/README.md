...
* **Налаштування**:
  * Реалізовано через ZMK `input-listener` у файлі [Keiler_left.overlay](./Keiler_left.overlay).
...
* Активовано режим сну безпосередньо для трекпада (`sleep;` у файлі [Keiler_right.overlay](./Keiler_right.overlay)), що значно економить заряд батареї на правій половині клавіатури.
